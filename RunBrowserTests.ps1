...
try
{
    ...
    if ($ENV:APPVEYOR -eq "true")
    {
        ...
        dir .$resultsPath\*.xml | %{ Write-Host "Uploading $_ to AppVeyor"; $client.UploadFile("https://ci.appveyor.com/api/testresults/junit/$($env:APPVEYOR_JOB_ID)", ".$resultsPath\$_") }
